...
<html>
    ...
    <body>
        ...
        <form action="" method="POST" action ="http://russel:9090/orgs/shortname/${it.uniqueShortName}" accept="application/json" enctype="" id="organizationform">
                        ...
                        <div class="inner-right-8" align="center"><input type="submit" value="submit" name="submitBtn" onclick="PostAsJson()"></div>
