...
<html>
    <head>
        ...
        <title><fmt:message key="org.titleSo"/>"</title>
        <link type="text/css" rel="stylesheet" href="<c:url value="/css/securedObjectList.css"/>" />
    ...
    <body>
        ...
        <div>
          <a href="javascript: Orgpageselect()"><h4><fmt:message key="SoCreate" />"</h4></a>
        </div>

        <div class="hide" id="create" align="center">
          <form action="<c:url value="/orgs/privs"/>" method="post" accept="application/json" enctype="" id="securedobjectform">
                ...
                <div class="inner-right-8" align="center"><input type="submit" value="<fmt:message key="privSubmitBtn"/>" name="${submitBtn}"></div>
            </form>
        </div>
    </body>
</html>
