...
<div id="leftmenu_userdeatils_1" class="leftmenu">
  ...
  <div id="leftmenu_body_userdeatils_1" class="leftmenu_body">
    <ul>
      ...
      <li><a href="javascript: Orgpageselect()"><fmt:message key="org.tablehead6"/></a></li>
    </ul>
  </div>
</div>
...
<div id="create" class="hide">
  ...
  <div id="form_organizationentry" class="entry_form">
    <form method="POST" action ="http://localhost:9090/orgs/${it.user.organization.uniqueShortName}/users/username/${it.user.username}/update" accept="application/json" id="userEditForm">
      ...
      <div class="form_textField"><input type="hidden" name="firstName" value="${it.person.self.name.firstName}" class="textField" id="name"></div>
      <div style="clear: both"></div>
      
      <div class="form_textField"><input type="hidden" name="middleInitial" value="${it.person.self.name.middleInitial}" class="textField" id="name"></div>
      <div style="clear: both"></div>
      
      <div class="form_textField"><input type="hidden" name="lastName" value="${it.person.self.name.lastName}" class="textField" id="name"></div>
      <div style="clear: both"></div>
      
      <div class="form_textField"><input type="hidden" name="nationalID" value="${it.person.self.nationalID}" class="textField" id="name"></div>
      <div style="clear: both"></div>
      
      <div class="form_textField"><input type="hidden" name="primaryEmail" value="${it.person.primaryEmail}" class="textField" id="name"></div>
      <div style="clear: both"></div>
      
      <div class="form_textField"><input type="hidden" name="cellPhoneNumber" value="${it.person.cellPhoneNumber}" class="textField" id="name"></div>
      <div style="clear: both"></div>
...
<%--<div id="changePassword" class="hide">
  ...
  <div id="header_organization_users" class="header_entry_form"><marquee><label id="header_user_label"><c:out value="${it.user.username}"></c:out>-Change your password</label></marquee></div>
  ...
  <div id="form_organizationentry" class="entry_form">
    <form method="POST" action ="http://localhost:9090/orgs/${it.user.organization.uniqueShortName}/users/username/${it.user.username}/update" accept="application/json" id="organizationform">
      ...
      <div class="form_textField"><input type="text" name="firstName" value="${it.person.self.firstName}" class="textField" id="name"></div>
      <div style="clear: both"></div>
      <div class="form_label"><label><fmt:message key="org.usrtablehead2"/></label></div>
      <div class="form_textField"><input type="text" name="middleInitial" value="${it.person.self.middleInitial}" class="textField" id="name"></div>
      <div style="clear: both"></div>
      <div class="form_label"><label><fmt:message key="org.usrtablehead3"/></label></div>
      <div class="form_textField"><input type="text" name="lastName" value="${it.person.self.lastName}" class="textField" id="name"></div>
      <div style="clear: both"></div>
      <div class="form_label"><label><fmt:message key="org.usrtablehead2"/></label></div>
