 ...
 * @author saumitra
 */
public class PersonSchemaBaseConfigProvider implements Provider<SchemaInfoProviderBaseConfig<Person>>{

  @Override
  public SchemaInfoProviderBaseConfig<Person> get() {
    try {
      final InputStream resourceAsStream = getClass().getClassLoader().getResourceAsStream(
          "com/smartitengineering/user/impl/person/PersonSchemaBaseConfig.json");
