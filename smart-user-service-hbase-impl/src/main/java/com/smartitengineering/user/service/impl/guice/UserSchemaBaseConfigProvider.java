 ...
 * @author saumitra
 */
public class UserSchemaBaseConfigProvider implements Provider<SchemaInfoProviderBaseConfig<User>>{

  @Override
  public SchemaInfoProviderBaseConfig<User> get() {
    try {
      final InputStream resourceAsStream = getClass().getClassLoader().getResourceAsStream(
          "com/smartitengineering/user/impl/organization/UserSchemaBaseConfig.json");
