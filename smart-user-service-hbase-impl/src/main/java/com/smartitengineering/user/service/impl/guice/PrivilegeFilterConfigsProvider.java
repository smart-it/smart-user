 ...
 * @author saumitra
 */
public class PrivilegeFilterConfigsProvider implements Provider<FilterConfigs<Privilege>>{

  @Override
  public FilterConfigs<Privilege> get() {
    try {
      final InputStream resourceAsStream = getClass().getClassLoader().getResourceAsStream(
          "com/smartitengineering/user/impl/privilege/PrivilegeFilterConfigs.json");
